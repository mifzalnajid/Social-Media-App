...
const CreatePost = () => {
    ...
    const handleSubmit = (event) => {
        ...
        //  --------------Setting its value to  default after posting--------------------
    ...
    return <form className="createPost" onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
            <label
                htmlFor="userId"
                className="form-label">Enter your user Id here</label>
            <input
                type="text"
                ref={userIdElement}
        ...
        <div className="mb-3">
            <label
                htmlFor="tags"
                className="form-label"> Enter your hashtag here</label>
            <input
                type="text"
                ref={tagsElement}
                className="form-control"
                id="tags"
                placeholder="Please enter tags usung spaces"
            />
        </div>
